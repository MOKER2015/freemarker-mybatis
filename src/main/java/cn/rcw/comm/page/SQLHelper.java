...
import cn.rcw.comm.util.StringUtils;
...
public class SQLHelper {
    ...
    public static int getCount(final String sql, final Connection connection,
    	...
    	String _sql = StringUtils.replaceSql(sql);
    	_sql = StringUtils.hasGroupby(_sql) ? "select count(1) from(" + _sql + ") tmp" :StringUtils.replaceOrderby(_sql);
        final String countSql = _sql;
